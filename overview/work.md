# Backlog Ecosistema (`$workeco`)

| ID | Tipo | Descripción | Cores Afectados | Estado |
|---|---|---|---|---|
| [w1] | [ECO] | Sanitización y desacoplamiento de boilerplate Flutter en Cores no-Flutter | Todos | hecho |
| [w2] | [ECO] | Estandarizar Quick Start en READMEs (SSH, sin mkdir -p, 3 bloques separados) | Todos | hecho |
| [w3] | [ECO] | Tracker de gobernanza y auditoría agéntica multinivel (3 capas) | Todos Cores/Skills | hecho |
...
- [w5] [ECO] Creación e integración de `multicore-agent-rules` en `MultiCore/` (100% Markdown agnóstico, adaptadores agénticos, core, knowledge, plantillas Hub & Spoke con contratos y matriz de congruencia cruzada backend-frontend) -> Razón: Proveer orquestación y gobernanza de congruencia semántica en proyectos políglotas y monorepos.
